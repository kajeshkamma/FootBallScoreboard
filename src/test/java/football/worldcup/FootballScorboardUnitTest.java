package football.worldcup;

import football.worldcup.exceptions.InvalidScoreException;
import football.worldcup.exceptions.MatchAlreadyExistException;
import football.worldcup.exceptions.MatchNotExistException;
...
public class FootballScorboardUnitTest {
	...
	public void _03_duplicateMatch() {
		...
		Exception exception = assertThrows(MatchAlreadyExistException.class, () -> footballService.startNewGame(match));
	...
	/**
	 * This is the test case to validate the initial score of an existing match
	 */
	@Test
	...
	/**
	 * This is the test case to validate update scores for an invalid match
	 */
	@Test
	public void _08_updateInvalidMatch() {
		FootballMatch match = new FootballMatch.Builder("Wales", "Denmark").build();
		Exception exception = assertThrows(MatchNotExistException.class, () -> footballService.updateScore(match));
	...
	public void _09_updateInvalidScores() {
		...
		Exception exception = assertThrows(InvalidScoreException.class, () -> footballService.updateScore(m1));

		String actualMessage = exception.getMessage();
		assertEquals(actualMessage, expectedMessage);
		
		FootballMatch m2 = new FootballMatch.Builder("Mexico", "Canada").setHomeTeamScore(-2).setAwayTeamScore(5).build();
		exception = assertThrows(InvalidScoreException.class, () -> footballService.updateScore(m2));
	...
	/**
	 * This is the test case to finish an in progress match.
	 */
	@Test
	...
	/**
	 * This is the test case to finish an in valid match
	 */
	@Test
	public void _12_finishInvalidMatch() {
		FootballMatch match = new FootballMatch.Builder("India", "Pakistan").build();
		Exception exception = assertThrows(MatchNotExistException.class, () -> footballService.finishInProgressGame(match));
	...
	public void _13_validateOrder() {
		...
		assertEquals("Belgium", match.getHomeTeam());
		assertEquals("Austrailia", match.getAwayTeam());
